...
public:
	...
	static void free_internal_collator (mscorlib_System_Globalization_CompareInfo * __this);
	static int internal_compare (mscorlib_System_Globalization_CompareInfo *,Il2CppString *,int,int,Il2CppString *,int,int,int);
	static int internal_index (mscorlib_System_Globalization_CompareInfo *__this, Il2CppString *source, int sindex, int count, Il2CppString *value, int options, bool first);
